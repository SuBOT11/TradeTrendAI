const basePath ="http://localhost:5000/api/info";
const basePath2 ="http://localhost:5000/api/graph";
...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?symbol=${query}`;
  console.log(url)
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile?symbol=${stockSymbol}`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath2}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}`;
  console.log(url)
  const response = await fetch(url);
...
export const fetchPredictedData = async(stockSymbol) => {
  const url = `${basePath2}/prediction?symbol=${stockSymbol}`;
  const response = await fetch(url);
...
export const  fetchRecommendedStocks = async(stockSymbol) => {
  const url = `${basePath}/recommend?symbol=${stockSymbol}`;
  const response = await fetch(url);
